...
#     If detach_ratio=True, ratio is detached but clipping is still applied.
...
def compute_policy_loss( 
    ...
    if detach_ratio:
        ...
        lower = 1.0 - cliprange
        upper = 1.0 + cliprange
        lower_decay = lower - cliprange  # 1 - 2ε
        upper_decay = upper + cliprange  # 1 + 2ε
        ...
        pg_losses = -advantages * effective_ratio
        pg_loss = verl_F.masked_mean(pg_losses, eos_mask)

        # For tracking how many samples were clipped (decay_mask < 1)
